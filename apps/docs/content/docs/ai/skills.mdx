---
title: AI Skills
description: Pre-installed Claude Code skills that help you build plugins without writing code.
---
...
- **Figma Dev Mode** — Lets Claude read your Figma files directly. Requires a `FIGMA_API_KEY` in `.claude/settings.json`.
- **Context7** — Fetches up-to-date library documentation so Claude doesn't use outdated APIs.
